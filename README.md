...
```text
codex-statusline · main · gpt-5.5 default · Context 14% used · 5h 98% left · weekly 69% left · 258K window
```

スクリーンショットはターミナル下部だけを切り抜いたものです。横幅が足りない環境でも内容が追えるように、同じ表示例をテキストでも併記しています。
